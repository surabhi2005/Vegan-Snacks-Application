...
//               <td style={styles.td}>{cert.issueDate ? new Date(cert.issueDate).toLocaleDateString() : "-"}</td>
//               <td style={styles.td}>{cert.expiryDate ? new Date(cert.expiryDate).toLocaleDateString() : "-"}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
